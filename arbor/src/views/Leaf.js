...
Leaf.prototype.setToolTip = function () {
    ...
    switch (this.myNode.stopSign) {
        case arbor.constants.diagnosisPlus:
            tText = `${localize.getString("sYourBestGuess")} ${arbor.state.dependentVariableSplit.branchDescription("L")}`;
            break;
        case arbor.constants.diagnosisMinus:
            tText = `${localize.getString("sYourBestGuess")} ${arbor.state.dependentVariableSplit.branchDescription("R")}`;
            break;
        default:
            tText = localize.getString("sLeafNoDiagnosis");
            break;
    }
