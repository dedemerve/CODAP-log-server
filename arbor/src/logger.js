...
(function () {
  ...
  function showOverlay(onReady) {
    ...
    overlay.innerHTML='<div id="_logBox"><h2>CODAP Arbor</h2><p>Lütfen adınızı ve soyadınızı girin.</p><input id="_logInput" type="text" placeholder="Adınız Soyadınız" autocomplete="off" maxlength="80"/><button id="_logBtn">Devam Et</button><div id="_logErr"></div></div>';
